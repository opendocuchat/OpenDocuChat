...
import {
  ...
  TreeNode,
  getSelectedPaths,
} from "@/components/feature/file-tree-node";
...
export default function GitHubRepoIndexing() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-4">GitHub Repo Indexing</h2>
      <Card className="mb-4">
        <CardHeader>
        ...
        <CardContent>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {[".js", ".py", ".md", ".txt", ".html", ".css"].map((type) => (
        ...
        <Card className="mb-4">
          ...
          <CardContent>
            ...
            <p className="text-sm mt-2">
              Progress:{" "}
              {((progress.processedFiles / progress.totalFiles) * 100).toFixed(
                2
              )}
              %
            </p>
